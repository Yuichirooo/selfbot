...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Er4JHwCqzcZdJr26q2Ud.QiPuwrj3C0f9vjAXzgmGFq.jcEq6QI2jX8YzQ8R8JsLRWiVMikV6oHIlEN6Hq7bu2U=')
vipro.loginResult()
print "Kirihara Login Success\n\n=====[Sukses Login]====="
...
╚════════════════════
"""
vip="ua88a5459127773417d5496b16463207d"
...
Bots=[mid]
Creator=["ua88a5459127773417d5496b16463207d"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like By : Kirihara-Bot",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            vipro.sendText(op.param1,"Moshi-Moshi [☞ " + vipro.getContact(op.param2).displayName + " ]\nWelcome To ☞ " + str(ginfo.name) + " ☜" + "\nBudayakan Cek Note\nDan Semoga Betah Disini ^_^")
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            vipro.sendText(op.param1,"Matta nee [☞ " + vipro.getContact(op.param2).displayName +  " ]\nSee You Next Time . . . ")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "13269542",
                                    "STKPKGID": "1329191",
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
                ...
                vipro.sendText(msg.to, "☆ Reader Check ☆")
                print "Setview"
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        total = '\n╠═══════════════════\n╠➩ Total %i Readers (%s)' % (len(dataResult), datetime.now().strftime('%H:%M:%S')) + "\n╚═══════════════════"
		...
		if midd not in admin:
		    ...
		    vipro.sendText(msg.to,"Admin Detected")
                ...
                midd = "ua88a5459127773417d5496b16463207d"
                vipro.inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
		    for i in gid:
			vipro.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~yuichiro-hyakuya")
		    vipro.sendText(msg.to,"Success BC")
		else:
		    vipro.sendText(msg.to,"Khusus Admin")
		...
		vipro.sendText(msg.to,"Kirihara Hadir!!")
